...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"874e7640-00af-4625-a9d2-d785430d0646\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [31 x i8] c"com.companyname.constructorbot\00", align 1
...
@__DSOCacheEntry_name.1 = internal constant [21 x i8] c"libsentry-android.so\00", align 1
@__DSOCacheEntry_name.2 = internal constant [50 x i8] c"libSystem.Security.Cryptography.Native.Android.so\00", align 1
@__DSOCacheEntry_name.3 = internal constant [25 x i8] c"libsentrysupplemental.so\00", align 1
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [289 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
