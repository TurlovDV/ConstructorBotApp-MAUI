...
@__DSOCacheEntry_name.5 = internal constant [13 x i8] c"libsentry.so\00", align 1
@__DSOCacheEntry_name.6 = internal constant [25 x i8] c"libsentrysupplemental.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 107313754, ; hash 0x6657a5a, from name: sentry-android
		i8 0, ; ignore
	...
	; 4
	%struct.DSOCacheEntry {
		i64 576847416, ; hash 0x2261fe38, from name: sentry.so
		i8 0, ; ignore
	...
	; 7
	%struct.DSOCacheEntry {
		i64 949642523, ; hash 0x389a651b, from name: libsentrysupplemental
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 8
	%struct.DSOCacheEntry {
		i64 1321770450, ; hash 0x4ec89dd2, from name: libsentrysupplemental.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 11
	%struct.DSOCacheEntry {
		i64 1940963916, ; hash 0x73b0c24c, from name: libsentry
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 12
	%struct.DSOCacheEntry {
		i64 1953398684, ; hash 0x746e7f9c, from name: sentry-android.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 17
	%struct.DSOCacheEntry {
		i64 2286124851, ; hash 0x88437f33, from name: sentrysupplemental
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 21
	%struct.DSOCacheEntry {
		i64 2788037032, ; hash 0xa62e11a8, from name: libsentry.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 24
	%struct.DSOCacheEntry {
		i64 3204953399, ; hash 0xbf07b537, from name: sentry
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 26
	%struct.DSOCacheEntry {
		i64 3580238603, ; hash 0xd5661b0b, from name: libsentry-android.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 27
	%struct.DSOCacheEntry {
		i64 3607042072, ; hash 0xd6ff1818, from name: sentrysupplemental.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 31
	%struct.DSOCacheEntry {
		i64 3855181216, ; hash 0xe5c965a0, from name: libsentry-android
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [289 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
