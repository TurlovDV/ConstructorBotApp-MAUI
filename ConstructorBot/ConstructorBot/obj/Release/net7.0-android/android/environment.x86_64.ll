...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"874e7640-00af-4625-a9d2-d785430d0646\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [31 x i8] c"com.companyname.constructorbot\00", align 16
...
@__DSOCacheEntry_name.1 = internal constant [21 x i8] c"libsentry-android.so\00", align 16
@__DSOCacheEntry_name.2 = internal constant [50 x i8] c"libSystem.Security.Cryptography.Native.Android.so\00", align 16
@__DSOCacheEntry_name.3 = internal constant [25 x i8] c"libsentrysupplemental.so\00", align 16
...
@__DSOCacheEntry_name.7 = internal constant [13 x i8] c"libsentry.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 458673685084674823, ; hash 0x65d8949534a9b07, from name: libsentry-android.so
		i8 0, ; ignore
	...
	; 2
	%struct.DSOCacheEntry {
		i64 2188106489450321563, ; hash 0x1e5db7425269d69b, from name: libsentrysupplemental.so
		i8 0, ; ignore
	...
	; 3
	%struct.DSOCacheEntry {
		i64 2345498308373134015, ; hash 0x208ce248d3dc3abf, from name: libsentry-android
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 4
	%struct.DSOCacheEntry {
		i64 4815088859415782439, ; hash 0x42d2a1ce636b2427, from name: sentry-android
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 11
	%struct.DSOCacheEntry {
		i64 7719684477814261409, ; hash 0x6b21d421c63746a1, from name: libsentry.so
		i8 0, ; ignore
	...
	; 13
	%struct.DSOCacheEntry {
		i64 8253457698523001591, ; hash 0x728a2c0c512d32f7, from name: sentrysupplemental
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 17
	%struct.DSOCacheEntry {
		i64 9624093491316413251, ; hash 0x858fa60a2b105343, from name: libsentrysupplemental
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 20
	%struct.DSOCacheEntry {
		i64 12610770176874613415, ; hash 0xaf0274a940b38aa7, from name: libsentry
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 22
	%struct.DSOCacheEntry {
		i64 15835399549990015895, ; hash 0xdbc2a3fdbd891397, from name: sentrysupplemental.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 23
	%struct.DSOCacheEntry {
		i64 16182454667829646360, ; hash 0xe093a0c835d91418, from name: sentry-android.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 25
	%struct.DSOCacheEntry {
		i64 16532311557350057852, ; hash 0xe56e91c4fbef677c, from name: sentry.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 28
	%struct.DSOCacheEntry {
		i64 16999848085640327916, ; hash 0xebeb97c3cc3232ec, from name: sentry
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [289 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
