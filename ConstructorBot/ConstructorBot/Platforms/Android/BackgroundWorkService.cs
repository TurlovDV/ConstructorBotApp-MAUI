...
namespace ConstructorBot
{
    ...
    public class BackgroundWorkService : Service, IBackgroundWorkService
    {
        ...
        public void Start()
        {
            Intent startService = new Intent(MainActivity.ActivityCurrent, typeof(BackgroundWorkService));
