...
namespace Telegram
{
    public class TelegramApi : IMessengerApi
    {
        ...
        public delegate Model.MessageModel.Message MessageUpdate(Model.MessageModel.Message message);

        public event MessageUpdate NewMessage = null!;

        public delegate void MessageAnswer(Model.MessageModel.Message messageSend);
        ...
        public void Start()
        {
            Name = bot.GetMeAsync().Result.FirstName;
        ...
        public async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            if (!_isBot)
            {
            //    Console.WriteLine("\tBot stopped: " + Name, ConsoleColor.Red);
                await bot.CloseAsync();
            }
            else
            {
                //Получение ответного сообщения от логики бота
                Model.MessageModel.Message message = null!;
                if (update.CallbackQuery != null)
                    message = new Model.MessageModel.Message()
                    {
                ...
                else if (update.Message!.Type.Equals(Bot.Types.Enums.MessageType.Text))
                    message = new Model.MessageModel.Message()
                    {
                ...
                if (messageAnswer.MessageType.Equals(Model.MessageModel.MessageType.Photo))
                {
                    ...
                    if (messageAnswer.Photo!.Id! == null)
                        MessageRequest(
                        new Model.MessageModel.Message()
                        {
                            MessageType = Model.MessageModel.MessageType.Photo,
                            Photo = new Photo()
                            {
                ...
                else if (messageAnswer.MessageType.Equals(Model.MessageModel.MessageType.Video))
                {
                    ...
                    if (messageAnswer.Video!.Id! == null)
                        MessageRequest(
                            new Model.MessageModel.Message()
                            {
                                MessageType = Model.MessageModel.MessageType.Video,
                                Video = new Model.MessageModel.ElementMessage.Video()
                                {
                ...
                else if (messageAnswer.MessageType.Equals(Model.MessageModel.MessageType.Audio))
                {
                    ...
                    if (messageAnswer.Audio!.Id! == null)
                        MessageRequest(
                            new Model.MessageModel.Message()
                            {
                                MessageType = Model.MessageModel.MessageType.Audio,
                                Audio = new Model.MessageModel.ElementMessage.Audio()
                                {
                ...
                else if (messageAnswer.MessageType.Equals(Model.MessageModel.MessageType.Document))
                {
                    ...
                    if (messageAnswer.Document!.Id! == null)
                        MessageRequest(
                            new Model.MessageModel.Message()
                            {
                                MessageType = Model.MessageModel.MessageType.Document,
                                Document = new Model.MessageModel.ElementMessage.Document()
                                {
                ...
                else if (messageAnswer.MessageType.Equals(Model.MessageModel.MessageType.GroupMedia))
                {
                    int count = 0;
        ...
        : null).ToList();
                    ...
                    {
                        MediaGroup mediaGroup1 = new MediaGroup();
                        if (item.Type == Bot.Types.Enums.MessageType.Photo)
                        {
                            mediaGroup1.Id = item.Photo!.ToList().Last().FileId;
                            mediaGroup1.type = MediaType.Photo;
                        }
                        if (item.Type == Bot.Types.Enums.MessageType.Video)
                        {
                            mediaGroup1.Id = item.Video!.FileId;
                            mediaGroup1.type = MediaType.Video;
                        }
                        if (item.Type == Bot.Types.Enums.MessageType.Document)
                        {
                            mediaGroup1.Id = item.Document!.FileId;
                            mediaGroup1.type = MediaType.Document;
                        }
                        if (item.Type == Bot.Types.Enums.MessageType.Audio)
                        {
                    ...
                    MessageRequest(
                        new Model.MessageModel.Message()
                        {
                            MessageType = Model.MessageModel.MessageType.GroupMedia,
                            MediaGroups = mediaGroups
                        });

                }
                else if (messageAnswer.MessageType.Equals(Model.MessageModel.MessageType.Text))
        ...
        private IReplyMarkup GetReplyMarkup(Model.MessageModel.Message message)
        {
            ...
            {
                var list = new List<List<Bot.Types.ReplyMarkups.KeyboardButton>>();

                //foreach (var item in message.KeyboardButton!.inline_keyboard!)
                foreach (var item in message.ReplyKeyboardMarkup!.Keyboard!)
                {
                    List<Bot.Types.ReplyMarkups.KeyboardButton> inlineKeyboardButtons = new List<Bot.Types.ReplyMarkups.KeyboardButton>();
                    foreach (var i in item)
                        inlineKeyboardButtons.Add(new Bot.Types.ReplyMarkups.KeyboardButton(i));
                    list.Add(inlineKeyboardButtons);
                }
